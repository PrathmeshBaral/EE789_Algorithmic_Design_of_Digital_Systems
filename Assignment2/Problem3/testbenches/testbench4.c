...
for(I = 0; I < N; I++)
{
    for(J = 0; J < N/8; J++)
    {
        ...
        if(I < N/2)
        {
            if(J < N/16)
            {
                init_A0_entry(I, J, (int64_t)A_send);
            }
            else
            {
                int j2 = J - N/16;
                init_A1_entry(I, j2, (int64_t)A_send);
            }
        }
        else
        {
            ...
            if(J < N/16)
            {
                init_A2_entry(i2, J, (int64_t)A_send);
            }
            else
            {
                int j2 = J - N/16;
                init_A3_entry(i2, j2, (int64_t)A_send);
            }
        }
...
for(I = 0; I < N; I++)
{
    for(J = 0; J < N/8; J++)
    {
        ...
        if(I < N/2)
        {
            if(J < N/16)
            {
                init_B0_entry(I, J, (int64_t)B_send);
            }
            else
            {
                int j2 = J - N/16;
                init_B2_entry(I, j2, (int64_t)B_send);
            }
        }
        else
        {
            ...
            if(J < N/16)
            {
                init_B1_entry(i2, J, (int64_t)B_send);
            }
            else
            {
                int j2 = J - N/16;
                init_B3_entry(i2, j2, (int64_t)B_send);
            }
        }
